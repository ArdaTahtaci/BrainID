  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-white/80 text-lg">Recording your unique brainwave patterns</p>
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
            <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              ...
              Enhanced Loading States Preview
            </h3>
            <p className="text-white/70 mb-4">
              Demonstration of enhanced loading states and progress tracking
            </p>
            <EnhancedLoadingStates
              steps={[
                {
                  title: "Identity Registration",
                  description: "Register EEG-based identity commitment",
                  status: "success",
                  estimatedTime: "30s"
                },
                {
                ...
                },
                {
                  ...
                  description: "Add member to verification group",
                  status: "loading",
                  estimatedTime: "20s"
                },
                {
