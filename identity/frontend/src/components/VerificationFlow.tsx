    ...
    try {
      ...
      if (registerUser.registerUser) {
        ...
        try {
          ...
          // 🎯 Demo delay: Extended wait for blockchain confirmation visibility
      ...
      // 🎯 Demo delay: Extended wait for better demo visibility
      ...
      // Step 5: Complete
      // 🎯 Demo delay: Extended wait for final completion visibility
